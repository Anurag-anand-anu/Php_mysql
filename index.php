    ...
    <tbody>
        ...
        <?php foreach($vehicles as $vehicle) {
            ...
            if (property_exists($vehicle, "engine")) {
                $engineString = "<span class='data-label'>Egnine type: </span><span class='vehicle-engine'>$vehicle->engine</span> ";
            };
            ...
            <tr>
                ...
                <td>
                    ...
                    <hr class="vehicle-hr">
                    <p class="right-aligned">$engineString<span class="data-label">Year: </span><span class="vehicle-year">$vehicle->year</span>
